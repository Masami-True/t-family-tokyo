    ...
    await transporter.sendMail({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;width:100%;max-width:600px;">
          ...
          <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">連絡方法</td><td style="padding:8px;border:1px solid #ddd;">${contact_method}</td></tr>
          <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">アカウントID/電話</td><td style="padding:8px;border:1px solid #ddd;">${contact_id}</td></tr>
          <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">SNS URL</td><td style="padding:8px;border:1px solid #ddd;">${sns_url || "未入力"}</td></tr>
          <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">フォロワー数</td><td style="padding:8px;border:1px solid #ddd;">${followers || "未入力"}</td></tr>
          <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">配信経験</td><td style="padding:8px;border:1px solid #ddd;">${experience}</td></tr>
